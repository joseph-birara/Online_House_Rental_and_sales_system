...
export const deleteHouse = (houseId, token) => {
  axios
    .delete(`${baseUrl}/houses/delete/${houseId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const updateHouse = (housedata, houseId, token) => {
  axios
    .post(`${baseUrl}/houses/update/${houseId}`, housedata, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const getCommnetbyOwner = (userId, token) => {
  axios
    .post(`${baseUrl}/comment/getByOwner/${userId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const getCommentByHouse = (houseId, token) => {
  axios
    .post(`${baseUrl}/comment/getbyhouse/${houseId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const createComment = (houseComment, token) => {
  axios
    .post(`${baseUrl}/comment/add`, houseComment, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const updateComment = (houseComment, token) => {
  axios
    .post(`${baseUrl}/comment/edit`, houseComment, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const createMaintenance = (maintenancedata, token) => {
  axios
    .post(`${baseUrl}/maintenance/send`, maintenancedata, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const updateMaintenance = (maintenancedata, token) => {
  axios
    .put(`${baseUrl}/maintenance/edit`, maintenancedata, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const getSpecificMaintenance = (maintenanceId) => {
  axios
    .put(`${baseUrl}/maintenance/single/${maintenanceId}`)
    .then((response) => {
      return response;
    })
    .catch((error) => {
